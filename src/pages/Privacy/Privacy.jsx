    ...
    <section className="privacy">
      <div className="wrapper">
        ...
        <p>
          ...
          безопасности персональных данных. Предпринимает их ИП Ортиков Андрей
          Георгиевич (далее — Оператор).
        </p>
        <p>
        ...
        <p>
          ...
          сети интернет по сетевому адресу https://двери-окна-орт.рф
        </p>
        <p>
        ...
        <p>
          ...
          веб-сайта https://двери-окна-орт.рф.{' '}
        </p>
        <p>
        ...
        <p>
          ...
          Оператору с помощью электронной почты dverioknaort@mail.ru.
        </p>
        <p>
        ...
        <p>
          ...
          сети Интернет по адресу https://двери-окна-орт.рф/privacy/.
        </p>
      </div>
    </section>
  );
