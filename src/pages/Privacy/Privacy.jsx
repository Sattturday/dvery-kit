    ...
    <section className='privacy'>
      <div className='wrapper'>
        ...
        <p>
          ...
          безопасности персональных данных. Предпринимает их ИП Купцалов Игорь
          Михайлович (далее — Оператор).
        </p>
        <p>
        ...
        <p>
          ...
          Оператор может получить о посетителях веб-сайта https://двери-кит.рф
        </p>
        ...
        <p>
          ...
          сети интернет по сетевому адресу https://двери-кит.рф
        </p>
        <p>
        ...
        <p>
          2.10. Пользователь — любой посетитель веб-сайта https://двери-кит.рф.{' '}
        </p>
        <p>
        ...
        <p>
          7.2. Персональные данные Пользователя никогда, ни при каких условиях
        ...
        <p>
          ...
          info@ваш-сайт.ru с пометкой "Актуализация персональных данных".
        </p>
        <p>
          7.4. Срок обработки персональных данных определяется достижением
        ...
        <p>
          ...
          электронной почты на электронный адрес Оператора info@ваш-сайт.ru с
          пометкой "Отзыв согласия на обработку персональных данных".
        </p>
        <p>
          7.5. Вся информация, которая собирается сторонними сервисами, в том
        ...
        <p>
          7.6. Установленные субъектом персональных данных запреты на передачу
        ...
        <p>
          7.8. При осуществлении доставки товаров Оператор может собирать данные
          о конечной точке доставки и получателе, чтобы точно рассчитать
          маршрут. Грузоперевозка осуществляется с помощью транспортных компаний
          и курьерских служб доставки. Цены по тарифам перевозчика в зависимости
          от объёма и массы груза, а так же удалённости от точки отправки. Для
          негабаритных и крупногабаритных грузов действуют особые условия
          перевозки, стоимость можно рассчитать через сайт ННВ-Негабарит
          (https://nnv-negabarit.ru/).
        </p>
        <p>
          7.9. Оператор осуществляет хранение персональных данных в форме,
        ...
        <p>
          7.10. Условием прекращения обработки персональных данных может
        ...
        <p>
          9.1. Оператор до начала осуществления деятельности по трансграничной
        ...
        <p>
          9.2. Оператор до подачи вышеуказанного уведомления, обязан получить от
        ...
        <p>
          11.1. Пользователь может получить любые разъяснения по интересующим
          вопросам, касающимся обработки его персональных данных, обратившись к
          Оператору с помощью электронной почты info@двери-кит.рф.
        </p>
        <p>
        ...
        <p>
          11.3. Актуальная версия Политики в свободном доступе расположена в
          сети Интернет по адресу https://двери-кит.рф/privacy/.
        </p>
      </div>
    </section>
  );
